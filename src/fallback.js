...
let showErrorDiv_forced = (callout, subject, body, isKnownIssueUrl) => {
    ...
    document.getElementById('error-mailto-anchor').innerText = 'Email the issue to mukiibirogerz@gmail.com';
    document.getElementById('error-mailto-anchor').href = [
        'mailto:mukiibirogerz@gmail.com?subject=',
        encodeURIComponent('QubitBoard had an error: ' + subject),
        '&body=',
        encodeURIComponent('\n\n\n' + body)
    ].join('');
    document.getElementById('error-github-anchor').href = [
        'https://github.com/rogersmukiibi/QubitBoard/issues/new?title=',
